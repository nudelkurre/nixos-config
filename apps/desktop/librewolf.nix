...
}:
{
    ...
    xdg.desktopEntries = lib.mkIf config.programs.librewolf.enable {
        "librewolf" = {
            actions = {
                "new-private-window" = {
                    exec = "${config.programs.librewolf.package}/bin/librewolf --private-window %U";
                    name = "New Private Window";
                };
                "profile-manager-window" = {
                    exec = "${config.programs.librewolf.package}/bin/librewolf --ProfileManager";
            ...
            exec = "${config.programs.librewolf.package}/bin/librewolf --new-window %U";
